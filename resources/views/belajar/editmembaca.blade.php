                        ...
                        <div class="basic-login-inner">
                            ...
                            @csrf
                                <div class="form-group-inner">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Masukkan nama" name="nama" value="{{ $membaca->nama}}">
                                </div>
                                <div class="form-group-inner">
                                    <div class="row">
                                        <div class="col-lg-2">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-select-list">
                                                <select id="tipe" type="text" class="form-control custom-select-value @error('tipe') is-invalid @enderror" name="tipe" value="{{ $membaca->tipe}}">
                                                    <option>Hewan</option>
                                ...
                                <div class="form-group-inner">
                                    ...
                                    <input type="text" name="tulisan_id" id="tulisan_id" class="form-control @error('tulisan_id') is-invalid @enderror" id="tulisan_id" placeholder="Masukkan Tulisan Bahasa Indonesia" name="tulisan_id" value="{{ $membaca->tulisan_id}}"/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group-inner">
                                    ...
                                    <input type="text" name="tulisan_en" id="tulisan_en" class="form-control @error('tulisan_en') is-invalid @enderror" id="tulisan_en" placeholder="Masukkan Tulisan Bahasa Indonesia" name="tulisan_en" value="{{ $membaca->tulisan_en}}"/>
                                </div>
                                <div class="form-group">
